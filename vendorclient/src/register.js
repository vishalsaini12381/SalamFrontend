							...
							<div className="col col-login mx-auto">
								...
								<form className="card " onSubmit={this.registerVendor} >
									<div className="card-body p-6">
										...
										<div className="form-group">
											<label className="form-label">Password <i onMouseOver={this.handleMouseIn} onMouseOut={this.handleMouseOut} className="fa fa-info-circle"> </i>
											</label>
											<div >
												<div style={tooltipStyle} className="Tooltip--Text">PassWord atleast 8 Character One Capital letter One Small letter One Special character And One Digit</div>
											</div>
