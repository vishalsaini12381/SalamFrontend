                    ...
                    <div className="col-md-3 col-lg-3">
                      <div className="form-group">
                        ...
                        <div className="custom-file">
                          ...
                          <img src={this.state.file1 === null ? "images/defaultImg.png" : this.state.file1} style={{ height: '270px', width: '220px', marginTop: '50px' }} />
                    ...
                    <div className="col-md-3 col-lg-3">
                      <div className="form-group">
                        ...
                        <div className="custom-file">
                          ...
                          <img src={this.state.file2 === null ? "images/defaultImg.png" : this.state.file2} style={{ height: '270px', width: '220px', marginTop: '50px' }} />
                          <label className="custom-file-label">Choose file</label>
                        </div>
                      </div>
                    ...
                    <div className="col-md-3 col-lg-3">
                      <div className="form-group">
                        ...
                        <div className="custom-file">
                          ...
                          <img src={this.state.file3 === null ? "images/defaultImg.png" : this.state.file3} style={{ height: '270px', width: '220px', marginTop: '50px' }} />
                          <label className="custom-file-label">Choose file</label>
                        </div>
                      </div>
                    ...
                    <div className="col-md-3 col-lg-3">
                      <div className="form-group">
                        ...
                        <div className="custom-file">
                          ...
                          <img src={this.state.file4 === null ? "images/defaultImg.png" : this.state.file4} style={{ height: '270px', width: '220px', marginTop: '50px' }} />
                          <label className="custom-file-label">Choose file</label>
                        </div>
                      </div>
                    </div>
